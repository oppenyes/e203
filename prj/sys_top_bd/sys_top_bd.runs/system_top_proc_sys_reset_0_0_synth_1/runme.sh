...
HD_PWD='E:/my_git/e203_zs/prj/sys_top_bd/sys_top_bd.runs/system_top_proc_sys_reset_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_top_proc_sys_reset_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_top_proc_sys_reset_0_0.tcl
