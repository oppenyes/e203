...
################################################################
# This is a generated script based on design: bd_bcc6
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net SLOT_0_GPIO_tri_i_1 [get_bd_ports SLOT_0_GPIO_tri_i] [get_bd_pins ila_lib/probe1]
  connect_bd_net -net SLOT_0_GPIO_tri_o_1 [get_bd_ports SLOT_0_GPIO_tri_o] [get_bd_pins ila_lib/probe2]
  connect_bd_net -net SLOT_0_GPIO_tri_t_1 [get_bd_ports SLOT_0_GPIO_tri_t] [get_bd_pins ila_lib/probe3]
