...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_snake_ctrl_0, and set properties
  set axi_snake_ctrl_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_snake_ctrl:1.0 axi_snake_ctrl_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_interconnect_0/M02_AXI] [get_bd_intf_pins axi_snake_ctrl_0/S00_AXI]
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_snake_ctrl_0/s00_axi_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins proc_sys_reset_16M/slowest_sync_clk] [get_bd_pins system_e203_0/clk_16M]
  ...
  connect_bd_net -net rst_clk_wiz_0_200M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_snake_ctrl_0/s00_axi_aresetn] [get_bd_pins proc_sys_reset_16M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces system_e203_0/expl_axi] [get_bd_addr_segs axi_snake_ctrl_0/S00_AXI/S00_AXI_reg] -force
