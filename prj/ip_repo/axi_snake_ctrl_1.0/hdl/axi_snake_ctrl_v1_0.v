...
wire [7:0] fixed_food_y  = 8'd78;
// Instantiation of Axi Bus Interface S00_AXI
	axi_snake_ctrl_v1_0_S00_AXI # ( 
		.C_S_AXI_DATA_WIDTH(C_S00_AXI_DATA_WIDTH),
		.C_S_AXI_ADDR_WIDTH(C_S00_AXI_ADDR_WIDTH)
	) axi_snake_ctrl_v1_0_S00_AXI_inst (
		...
		// ?? 你可以把这些连出去和贪吃蛇游戏逻辑相连
    .direction_cmd                      (direction_cmd             ),// 方向控制输出（1=上，2=下，3=左，4=右）
    .snake_x                            (fixed_snake_x                   ),// 当前蛇头x坐标
